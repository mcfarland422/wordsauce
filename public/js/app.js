...
document.addEventListener("DOMContentLoaded", function () {
  document.querySelector("main").style.maxHeight = "calc(var(--vh, 1vh) * 94)";
});
...
/* harmony export */ });
var theWords = ["cat", "dog", "kid", "mom", "big", "hat", "pig", "boy", "yay", "can", "arm", "ran", "run", "sun", "fun", "hit", "sit", "sad", "hot", "far", "mad", "lip", "mud", "pot", "cut", "bad", "try"];
